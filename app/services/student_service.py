...
def get_classes_grades_of_student(class_assignment_id: int):
    ...
    grade = db.query(Grade).filter(Grade.assignment_id == class_assignment_id).first()
...
def get_average_grade_of_student(user_id: int):
    ...
    for assignment in student.assignments:
        grade = db.query(Grade).filter(Grade.assignment_id == assignment.assignment_id).first()
